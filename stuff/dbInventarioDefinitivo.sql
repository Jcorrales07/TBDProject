...
(
    ...
    id_username character varying(50) COLLATE pg_catalog."default" NOT NULL,
...
(
    ...
    id_usuario character varying(50) COLLATE pg_catalog."default" NOT NULL,
    nombre character varying(45) COLLATE pg_catalog."default" NOT NULL,
    costo double precision NOT NULL,
...
(
    ...
    clave character varying(45) COLLATE pg_catalog."default" NOT NULL,
...
(
    id_username character varying(50) COLLATE pg_catalog."default" NOT NULL,
    id_rol integer NOT NULL,
    CONSTRAINT usuario_rol_pkey PRIMARY KEY (id_username, id_rol)
);

ALTER TABLE IF EXISTS public.ajuste
    ADD CONSTRAINT fk_ajuste_usuario FOREIGN KEY (id_username)
    REFERENCES public.usuario (username) MATCH SIMPLE
    ON UPDATE RESTRICT
    ON DELETE RESTRICT;
CREATE INDEX IF NOT EXISTS ajuste_fk_ajuste_usuario_idx
    ON public.ajuste(id_username);


ALTER TABLE IF EXISTS public.cliente
    ADD CONSTRAINT fk_cliente_usuario FOREIGN KEY (id_username)
    REFERENCES public.usuario (username) MATCH SIMPLE
    ON UPDATE RESTRICT
    ON DELETE RESTRICT;
CREATE INDEX IF NOT EXISTS cliente_fk_cliente_usuario_idx
    ON public.cliente(id_username);


ALTER TABLE IF EXISTS public.compra
    ADD CONSTRAINT fk_compra_usuario FOREIGN KEY (id_username)
    REFERENCES public.usuario (username) MATCH SIMPLE
    ON UPDATE RESTRICT
    ON DELETE RESTRICT;
CREATE INDEX IF NOT EXISTS compra_fk_compra_usuario_idx
    ON public.compra(id_username);
...
ALTER TABLE IF EXISTS public.factura
    ADD CONSTRAINT fk_factura_usuario FOREIGN KEY (id_username)
    REFERENCES public.usuario (username) MATCH SIMPLE
    ON UPDATE RESTRICT
    ON DELETE RESTRICT;
CREATE INDEX IF NOT EXISTS factura_fk_factura_usuario_idx
    ON public.factura(id_username);
...
ALTER TABLE IF EXISTS public.proveedor
    ADD CONSTRAINT fk_proveedor_usuario FOREIGN KEY (id_username)
    REFERENCES public.usuario (username) MATCH SIMPLE
    ON UPDATE RESTRICT
    ON DELETE RESTRICT;
CREATE INDEX IF NOT EXISTS proveedor_fk_proveedor_usuario_idx
    ON public.proveedor(id_username);
...
ALTER TABLE IF EXISTS public.usuario_rol
    ADD CONSTRAINT fk_rol_usuario FOREIGN KEY (id_username)
    REFERENCES public.usuario (username) MATCH SIMPLE
    ON UPDATE RESTRICT
    ON DELETE RESTRICT;
